...
This is the readme for Drifter, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Drifter) > Ok.
...
- To run the project find Drifter.java (which will be in under src/main/java/ca/volatilecobra) and right click > Run 'Drifter'
