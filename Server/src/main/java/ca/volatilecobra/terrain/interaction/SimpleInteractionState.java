package ca.volatilecobra.terrain.interaction;

import ca.volatilecobra.terrain.core.ApplicationContext;
import ca.volatilecobra.terrain.input.MappedInput;
import ca.volatilecobra.terrain.interaction.brush.DensityBrush;
...
public class SimpleInteractionState extends BaseAppState {
    ...
    public void update(float tpf) {
        ...
        this.lastLocation = cam.getLocation();
